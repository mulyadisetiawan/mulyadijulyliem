...
============================================= */
window.MUSIC = {
        'url': "https://mulyadisetiawan.github.io/mulyadijulyliem/assets/music/song.mp3",
        'box': '#music-box'
    };
window.EVENT = 1750482946;
window.BOOKS = [{"bank":"Bank Central Asia (BCA)","number_account":"1140272406"}];
...
function sendComment(data) {
    ...
    var settings = {
        "async": true,
        "crossDomain": true,
        "url": "https://mulyadijulyliem-623a.restdb.io/rest/wishes",
        "method": "POST",
        "headers": {
          "content-type": "application/json",
          "x-apikey": "68563c49bb5ccc1c3cf6d9b3",
          "cache-control": "no-cache"
        },
        "processData": false,
        "data": JSON.stringify(data)
...
function getComments() {
    ...
    var settings = {
        "async": false,
        "crossDomain": true,
        "url": 'https://mulyadijulyliem-623a.restdb.io/rest/wishes?q={}&h={"$orderby": {"date": -1}}',
        "method": "GET",
        "headers": {
          "content-type": "application/json",
          "x-apikey": "68563c49bb5ccc1c3cf6d9b3",
...
// ----------- COUNTDOWN (Function) ------------------------------------------------------
(function countdown(){
    var schedule = new Date("2025-10-19 10:00:00"),
